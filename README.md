# BO-ucin OpenAPI Specification
[![Build Status](https://travis-ci.org/Oonan/api-bo.svg?branch=master)](https://travis-ci.org/Oonan/api-bo)
...
6. If you did everything correct, https://oonan.github.io/api-bo/ will lead to your new docs
...
- Documentation(ReDoc): https://oonan.github.io/api-bo/
- SwaggerUI: https://oonan.github.io/api-bo/swagger-ui/
- Look full spec:
    + JSON https://oonan.github.io/api-bo/swagger.json
    + YAML https://oonan.github.io/api-bo/swagger.yaml
- Preview spec version for branch `[branch]`: https://oonan.github.io/api-bo/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://oonan.github.io/api-bo/ with url from the message: `Server started <url>`
